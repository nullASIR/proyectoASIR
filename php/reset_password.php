...
<body>
    <div class="contenedor-auth">
        ...
        <?php else: ?>
            <?php if ($mensaje != ""): ?>
                <div class="msg-error"
                    style="color: red; border: 1px solid red; padding: 15px; border-radius: 8px; text-align: center; margin-bottom: 20px;">
                    <?php echo $mensaje; ?>
                </div>
            <?php endif; ?>
            ...
            <?php else: ?>
                ...
                <?php endif; ?>
                <a href="olvide_contrasena.php" class="btn btn-outline btn-block"
                    style="text-align: center; margin-top: 15px;">Solicitar nuevo enlace</a>
            <?php endif; ?>
