    ...
    <div class="contenedor-auth">
        ...
        <?php if ($exito): ?>
            <div class="msg-success"
                style="color: green; border: 1px solid green; padding: 15px; border-radius: 8px; text-align: center; margin-bottom: 20px;">
                <strong>Aviso:</strong> <?php echo $mensaje; ?>
            </div>

            <?php if ($debug_link): ?>
                <div class="msg-warning"
                    style="background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba; padding: 15px; border-radius: 8px; text-align: center; margin-bottom: 20px; overflow-wrap: anywhere;">
        ...
        <?php else: ?>
            ...
            <a href="../index.php" style="display: block; text-align: center; margin-top: 15px;">Volver al Inicio de
                Sesión</a>
        <?php endif; ?>
    </div>
</body>
