...
<body>
    ...
    <section class="contact-hero">
        ...
        <div class="container text-center">
            ...
            <p class="hero-subtitle">¿Buscas una carta en específico? ¿Tienes problemas con un pedido? Ponte en contacto
                con nuestro equipo de Expertos Pokémon.</p>
        </div>
    </section>
    ...
    <section class="contact-section container">
        <div class="contact-grid">
            ...
            <div class="contact-form-wrapper">
                ...
                <form class="premium-form" action="#" method="POST"
                    onsubmit="event.preventDefault(); alert('¡Mensaje enviado con éxito! Nuestro equipo te contactará pronto.');">
